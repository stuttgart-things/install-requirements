...
| date | release-name | git_tag | test | version-info | comment | package | release | editor |
|---|---|---|---|---|---|---|---|---|
...
| 2020-10-23 | install-openshift-aws-4.4.15 | sthings-install-openshift-aws-release-4.4.15 | failed | ocp: 4.4.3 | works fine  | [ocp4-aws-releases](http://10.31.102.191:5000/buckets?chosenbucket=install-openshift-aws) | false |cmueller |
